...
/// Orders each expanded cycle's completion after its whole body.
/// A diverging cycle has no result to order; its independent siblings may
/// occupy the same rows, as they do beside any other branch.
